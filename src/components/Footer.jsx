...
const Footer = () => {
    return (
        ...
        <footer className="site-footer">
            <div className="container">
                <div className="row gap-4 mb-3">
                    <div className="col-sm-11 col-md-5">
                        <h6>About</h6>
                        <p className="text-justify">Mr Lighthouse <i>CODE WANTS TO BE SIMPLE </i> is an initiative  to help Awsome Font-end and backend. we provide Html, Css, JS , React, static and dynamic website. we uselly use <b>React</b> to more fast and dynamic and no annoying page refreshing websites </p>
                    </div>
            ...
            <div className="carryer border-top">
                <div className="row">
                    <div className="col-md-8 col-sm-6 col-xs-12">
                        <p className="copyright-text">Copyright &copy; 2021 All Rights Reserved by
                            <a href="https://preview-shop.netlify.app/"> <i>Mr LightHouse </i> </a>.
                        </p>
                    </div>

                    <div className="col-md-4 col-sm-6 col-xs-12">
                        <ul className="social-icons">
                            <li><a className="facebook" href="/"><svg
                            ...
                            <li><a className="twitter" href="/"> <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
                                height="16"
                                fill="currentColor"
                            ...
                            <li><a className="dribbble" href="/">  <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
                                height="16"
                                fill="currentColor"
